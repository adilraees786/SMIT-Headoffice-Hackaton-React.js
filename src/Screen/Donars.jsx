    ...
    return (
        <div>
            ...
            {users.map((item, idx) => (
                ...
                <div key={idx} onClick={() => navigate('/chat', { state: { ...item, myUid } })} className="cursor-pointer bg-red-600 w-11/12 mb-2 shadow-md border border-black shadow-gray-300 rounded-md mx-auto py-5 px-10 flex justify-between">
